...
import com.cookandroid.dakku.R;
...
public class StickerView extends FrameLayout {
  ...
  public void configDefaultIcons() {
    BitmapStickerIcon deleteIcon = new BitmapStickerIcon(
        ContextCompat.getDrawable(getContext(),R.drawable.ic_close_white_s),
    ...
    BitmapStickerIcon turnIcon = new BitmapStickerIcon(
            ContextCompat.getDrawable(getContext(), R.drawable.ic_turn),
            BitmapStickerIcon.RIGHT_BOTTOM);
    turnIcon.setIconEvent(new TurnIconEvent());
